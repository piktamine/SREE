    ...
    <body>
        <div class="tamcarta">
            ...
            @foreach($datos as $d)
                ...
                @php if($i == 3){ echo '<div class="page-break"></div>'; $i = 1; }else{ $i++; } //Esto es para que cada hoja tenga 3 reportes @endphp

                <table class="tabla" width="100%" style="margin-bottom: 20px;">
                    <th>
                        <th>Alumno: {{$d['alumno'] ?? ''}}</th>
                    </th>
                </table>
